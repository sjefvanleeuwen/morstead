namespace Vs.VoorzieningenEnRegelingen.Core.TestData.YamlScripts
{
 ...
 - key: stap.inkomensdrempel.situatie.alleenstaande
   ...
   tekst: Wanneer u als alleenstaande meer inkomen heeft dan €{{toetsingsinkomensdrempel}} per jaar, overschrijdt u de inkomensdrempel. U heeft dan geen recht op zorgtoeslag.
 ...
 - key: stap.inkomensdrempel.situatie.alleenstaande.keuze.hoger_dan_inkomensdrempel
   tekst: Ja, mijn inkomen is **hoger** dan €{{toetsingsinkomensdrempel}}
   hint: De huidige inkomensdrempel voor alleenstaanden is €{{toetsingsinkomensdrempel}} per jaar.
 - key: stap.inkomensdrempel.situatie.alleenstaande.keuze.lager_dan_inkomensdrempel
   tekst: Nee, mijn inkomen is **lager** dan €{{toetsingsinkomensdrempel}}
 - key: stap.inkomensdrempel.situatie.aanvrager_met_toeslagpartner
   vraag: Is uw toetsingsinkomen hoger dan de inkomensdrempel?
   titel: Inkomensdrempel
   tekst: Wanneer u samen met een toeslagpartner meer inkomen heeft dan €{{toetsingsinkomensdrempel}} per jaar overschrijdt u de inkomensdrempel. U heeft dan geen recht op zorgtoeslag.
 ...
 - key: stap.inkomensdrempel.situatie.aanvrager_met_toeslagpartner.keuze.hoger_dan_inkomensdrempel
   tekst: Ja, het gezamenlijk inkomen is **hoger** dan €{{toetsingsinkomensdrempel}}
   hint: De huidige inkomensdrempel voor aanvragers met toeslagpartners is €{{toetsingsinkomensdrempel}} per jaar
 - key: stap.inkomensdrempel.situatie.aanvrager_met_toeslagpartner.keuze.lager_dan_inkomensdrempel   
   tekst: Nee, het gezamenlijk inkomen is **lager** dan €{{toetsingsinkomensdrempel}}
