...
namespace Vs.OrleansTests.publications
{
    public class PublicationTests : IClassFixture<ClusterFixture>
    {
        ...
        public async void ShouldPersistPublication()
        {
            ...
            var grain = cluster.GrainFactory.GetGrain<IPublicationGrain>("did:vsoc:mstd:pub:Sp8WbN5r0E6MCEx54Is3oQ");
            await grain.Create(new ContentType("application/yaml"), Encoding.UTF8, Encoding.UTF8.GetBytes(target));
            var grain2 = cluster.GrainFactory.GetGrain<IPublicationGrain>("did:vsoc:mstd:pub:Sp8WbN5r0E6MCEx54Is3oQ");
