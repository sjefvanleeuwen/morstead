...
namespace Vs.YamlEditor.Components.Controllers.ApiCalls
{
    ...
    public partial class RulesControllerDisciplClient
    {
        ...
        /// <summary>Executes a yaml rule file from a given uri.</summary>
        /// <returns>Executed</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ExecuteRuleYamlFromUriResponse> ExecuteRuleYamlAsync(ExecuteRuleYamlFromUriRequest request)
        {
            return ExecuteRuleYamlAsync(request, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Executed</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<ExecuteRuleYamlFromUriResponse> ExecuteRuleYamlAsync(ExecuteRuleYamlFromUriRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1-discipl/rules/execute-rule");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromUriResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromUriResponse>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<ExecuteRuleYamlFromUriResponse>("Yaml rule set contains errors", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "404")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromUriResponse>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<ExecuteRuleYamlFromUriResponse>("Yaml rule uri endpoint does not contain any rules", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "500")
                        {
                        ...
                        return default(ExecuteRuleYamlFromUriResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <summary>Executes a yaml rule using its content.</summary>
        /// <returns>Executed</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ExecuteRuleYamlFromContentResponse> ExecuteRuleYamlContentsAsync(ExecuteRuleYamlFromContentRequest request)
        {
            return ExecuteRuleYamlContentsAsync(request, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Executed</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<ExecuteRuleYamlFromContentResponse> ExecuteRuleYamlContentsAsync(ExecuteRuleYamlFromContentRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1-discipl/rules/execute-rule-from-contents");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromContentResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromContentResponse>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<ExecuteRuleYamlFromContentResponse>("Yaml rule set contains errors", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "404")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ExecuteRuleYamlFromContentResponse>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<ExecuteRuleYamlFromContentResponse>("Yaml rule set does not contain any rules", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "500")
                        {
                        ...
                        return default(ExecuteRuleYamlFromContentResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1-discipl/rules?");
            if (endpoint != null)
            {
