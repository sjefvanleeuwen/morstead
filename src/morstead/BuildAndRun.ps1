...
Start-Process "dotnet" -ArgumentList "run --project src/Vs.Orleans.SiloHost --no-build"
Start-Sleep 10
Start-Process "dotnet" -ArgumentList "run --project src/Vs.Rules.OrleansTestClient --no-build"
