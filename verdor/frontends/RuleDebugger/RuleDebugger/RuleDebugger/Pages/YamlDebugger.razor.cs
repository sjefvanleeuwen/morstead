...
namespace RuleDebugger.Pages
{
    public partial class YamlDebugger
    {
        //monaco documentation: https://microsoft.github.io/monaco-editor/api/index.html
        //github site: https://github.com/serdarciplak/BlazorMonaco
        //example BlazorMonaco: https://serdarciplak.github.io/BlazorMonaco/

        private string Yaml = @"# Zorgtoeslag for burger site demo
stuurinformatie:
  ...
  - naam: woonlandfactoren
    woonland, factor:
      ...
      - [Anders,              0      ]";
        ...
        //private StandaloneEditorConstructionOptions GetConstructionOptions()
        //{
        //    return YamlConstructionOptions();
        //}

        private StandaloneEditorConstructionOptions YamlConstructionOptions(MonacoEditor editor)
        {
