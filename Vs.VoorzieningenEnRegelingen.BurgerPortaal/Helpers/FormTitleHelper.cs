...
namespace Vs.VoorzieningenEnRegelingen.BurgerPortaal.Helpers
{
    public static class FormTitleHelper
    {
        ...
        private static Dictionary<string, string> _questionDescription = new Dictionary<string, string> { 
            ...
            { "hoger_dan_de_inkomensdrempel", "Afhankelijk van uw situatie; wanneer u als alleenstaande meer verdient " +
            ...
            { "hoger_dan_de_vermogensdrempel", "Afhankelijk van uw situatie; wanneer u als alleenstaande meer vermogen heeft dan " +
